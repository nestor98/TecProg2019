public class Main
{
	/* **************************************************************
	 * POR DONDE VOY: 
	 *	Aclararme con las herencias y demas de Java. Y hacer las 
	 *  cabeceras de este fichero... 
	 *	Implementar AgrupacionDinamica
	 *	(y de la parte de c++ queda mirar el tema de destructores)
	 * **************************************************************/
